...
3. Write a paragraph to introduce yourself. Set your name in bold font and your major in italic. 
    ...
    Answer: My name is **Andrew Fahmy** and I am a *Computer Science* major at Iowa State. I am currently taking DS 202 where we are learning how to use R!
...
4. Write a paragraph describing a job that you think is related to data science. Include a hyperlink and an image. Make sure your answer is in a nice format to read. 
    ...
    Answer: One job that uses data science would be machine learning at [Tesla](https://www.tesla.com/). They have self driving features in their cars that use data science to gather and analyze data in order to help them improve how good the self driving is. ![Self driving example](https://external-content.duckduckgo.com/iu/?u=https%3A%2F%2Fwww.teslarati.com%2Fwp-content%2Fuploads%2F2019%2F04%2Ftesla-fsd-demo-stop-sign-1.jpg&f=1&nofb=1)
  
5. What data topic will you be most interested in? (Optional) Provide a source of such dataset if you have.

    Answer: I think I will be most interested in almost and topic. There is so much that can be done with the large amounts of data that we have nowadays and it can be used to show trends and help predict things that we impossible before.
